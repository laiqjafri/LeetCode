...
class RandomizedSet:
    ...
    def remove(self, val: int) -> bool:
        ...
        """
        if not val in self.dict_:
            return False

        replace_val = self.list_[-1]
        self.list_[self.dict_[val]], self.list_[-1] = self.list_[-1], self.list_[self.dict_[val]]
        self.dict_[replace_val] = self.dict_[val]
